import { canvas, contextCanvas, containerCanvas, cores } from "./variaveis.js";
...
function fillShape(event, corSelecionadaBaldeTinta) {
    ...
    // Perform flood fill
    floodFill(positionX, positionY, targetColor, cores[corSelecionadaBaldeTinta], imageData, visited);
